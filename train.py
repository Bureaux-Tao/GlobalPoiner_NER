...
from path import BASE_CONFIG_NAME, BASE_CKPT_NAME, BASE_MODEL_DIR, train_file_path, val_file_path, \
...
from dataloader import load_data, data_generator, NamedEntityRecognizer
...
optimizer, optimizer_name = bert.get_optimizer()
NER = NamedEntityRecognizer(tokenizer, model, categories)

# model.load_weights("/home/bureaux/Projects/globalpointer_ner/weights/chip_roformer_v2_AdaFactorEMA_FINAL.h5")
...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs = None):
        ...
        save_file_path = ("{}/{}_{}_{}_FINAL".format(weights_path, event_type, MODEL_TYPE, optimizer_name)) + ".h5"
        # print(NER.trans)
        if "EMA" in optimizer_name:
...
train_plot(history.history, history.epoch, optimizer_name)
data = {
